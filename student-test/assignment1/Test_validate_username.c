...
void test_validate_my_username()
{
     ...
     */
    const char* username_func = my_username();
    char* username_mall = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(username_func, username_mall, "Username doesn't match");
